...
const AppCheckout: React.FC = () => {
  ...
  return (
    <div className="app-checkout-wrapper">
        ...
        <div className="content-grid">
          ...
          <div className="plan-details-card">
            ...
            <div className="trial-notice">
              إطلاق فوري لتطبيقك خلال دقائق
            </div>

            <button
              onClick={() => navigate('/dashboard/app/setup')}
            ...
            <div className={`feature-item ${openIndex === i + 100 ? 'active' : ''}`} key={i}>
              ...
              >
                ...
                <div
                  className="feature-inner"
                  ref={(el) => {
                    contentRefs.current[i + featuresUX.length] = el;
                  }}
                >
                  {item.desc}
                </div>
      ...
      <style>{`
        ...
        .btn-activate-trial:hover::after {
          left: 120%;
        }
